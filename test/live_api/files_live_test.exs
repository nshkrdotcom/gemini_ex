defmodule Gemini.APIs.FilesLiveTest do
  ...
  setup do
    ...
    if is_nil(api_key) or api_key == "" do
      flunk("GEMINI_API_KEY environment variable is required for live tests")
    end
  ...
  describe "upload/2" do
    @tag :live_api
    test "uploads an image file successfully" do
    ...
    @tag :live_api
    test "uploads a text file successfully" do
    ...
    @tag :live_api
    test "uploads with custom display_name" do
    ...
    @tag :live_api
    test "uploads with explicit mime_type" do
  ...
  describe "upload_data/2" do
    @tag :live_api
    test "uploads binary data successfully" do
    ...
    @tag :live_api
    test "returns error when mime_type is missing" do
      data = "test data"
  ...
  describe "get/2" do
    @tag :live_api
    test "retrieves file metadata by name" do
    ...
    @tag :live_api
    test "retrieves file without files/ prefix" do
      {:ok, uploaded} = Files.upload(@test_image_path)
  ...
  describe "list/1" do
    ...
    @tag :live_api
    test "lists files with page_size" do
  ...
  describe "list_all/1" do
    @tag :live_api
    test "lists all files across pages" do
  ...
  describe "wait_for_processing/2" do
    ...
    @tag :live_api
    test "calls on_status callback during polling" do
      {:ok, uploaded} = Files.upload(@test_image_path)
  ...
  describe "integration: upload and use in generation" do
    @tag :live_api
    @tag :slow
    test "uploads image and uses it in content generation" do
      # Upload the image
      {:ok, file} = Files.upload(@test_image_path)
